...
namespace PokerChallengeRef
{
    public class PokerHand : PokerPlayer
    {
        ...
        public SuitType DominantSuit = SuitType.N;
        ...
        public void Arrange(PokerPlayer playerdetail)
        {
            this.Copy(playerdetail);
            ...
            {
                this.Category = Category.ThreeOfaKind;
            }
            else if (CheckIsPair())
            {
                this.Category = Category.OnePair;
            }
            else { this.Category = Category.HighCard; }
